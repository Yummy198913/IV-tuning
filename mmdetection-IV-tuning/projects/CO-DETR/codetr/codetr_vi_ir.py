...
from mmdet.models.detectors.base import BaseDetector, BaseDetector_vi_ir
...
class CoDETR_vi_ir(BaseDetector_vi_ir):
    ...
    def __init__(
        ...
        super(CoDETR_vi_ir, self).__init__(
    ...
    def loss(self, batch_inputs_vi: Tensor, batch_inputs_ir: Tensor,
        ...
        x = self.extract_feat(batch_inputs_vi, batch_inputs_ir)
    ...
    def predict(self,
        ...
        img_feats = self.extract_feat(batch_inputs_vi, batch_inputs_ir)
