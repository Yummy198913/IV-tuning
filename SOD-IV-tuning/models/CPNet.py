...
class CPNet(nn.Module):
    def __init__(self):
        ...
        self.rgb_swin = SwinTransformer(embed_dim=192, depths=[2,2,18,2], num_heads=[6,12,24,48])
        self.depth_swin = SwinTransformer(embed_dim=192, depths=[2,2,18,2], num_heads=[6,12,24,48])
    ...
    def forward(self,x ,d):
        rgb_list = self.rgb_swin(x)  # [192, 96, 96], [384, 48, 48], [768, 24, 24], [1536, 12, 12]
