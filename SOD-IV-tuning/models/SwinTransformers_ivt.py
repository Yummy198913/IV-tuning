...
class SwinTransformerBlock(nn.Module):
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,
        ...
        self.hmps_ivt = HMPS(dim, 64)  # fixme
    ...
    def forward(self, x, x1):
        ...
        adapt_x = self.hmps_ivt(x, x1, (H, W))
        x = x + adapt_x
...
class SwinTransformer_ivt_pro(nn.Module):
    def __init__(self, img_size=384, patch_size=4, in_chans=3, num_classes=1000,
        ...
        self.trainable_params = ['ivt']
        if 'all' in self.trainable_params:
    ...
    def forward_features(self, x, z):
        ...
        z, hw_size = self.patch_embed_ivt(z)

        '''prompt at input'''
        x_feat = self.hmp_ivt(x, z, hw_size)  # 1, 1024, 32, 32
    ...
    def forward(self, x, z):
        outs = self.forward_features(x, z)
