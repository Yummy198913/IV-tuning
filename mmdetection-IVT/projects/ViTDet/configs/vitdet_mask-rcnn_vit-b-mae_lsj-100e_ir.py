...
backend_args = None
batch_augments = [ dict(pad_mask=True, size=(1024,1024,), type='BatchFixedSizePad'),]
...
model = dict(
    backbone=dict(
        ...
        init_cfg=dict(checkpoint='/raid/liufangcen/updata/checkpoint/checkpoint-399.pth', type='Pretrained')),
...
work_dir = './work_dirs/vitdet_mask-rcnn_convmae_lsj-100e_ir'