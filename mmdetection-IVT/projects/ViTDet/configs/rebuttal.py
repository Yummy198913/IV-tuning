...
model = dict(
    backbone=dict(
        ...
        init_cfg=dict(
            checkpoint='/raid/liufangcen/updata/checkpoint/infmae/checkpoint-399.pth',
            type='Pretrained'),
        init_values=1.0,
        mlp_ratio=[
            4,
...
test_evaluator = dict(
    ann_file=
    '/raid/liufangcen/data/M3FD-TO-LIU/annotations_coco/instances_val2017_with_gt_masks.json',
    format_only=False,
    metric=[
        'bbox',
        'segm',
...
work_dir = './work_dirs/vitdet_mask-rcnn_convmae_lsj-100e_vi_rebuttal'